...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/analysis/analysisModule.js',
			'app/modules/analysis/analysisCtrl.js',
			'app/modules/analysis/analysisRoute.js',
			'app/modules/analysis/analysisService.js',
			'app/modules/analysis/analysis-test.js',
			'app/modules/history/historyModule.js',
			'app/modules/history/historyCtrl.js',
			'app/modules/history/historyRoute.js',
			'app/modules/history/historyService.js',
			'app/modules/history/history-test.js',
		],
